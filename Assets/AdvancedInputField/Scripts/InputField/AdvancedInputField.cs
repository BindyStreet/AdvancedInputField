...
namespace AdvancedInputFieldPlugin
{
    ...
    public class AdvancedInputField : Selectable, IPointerClickHandler, IPointerExitHandler, IBeginDragHandler, IDragHandler, IEndDragHandler, IUpdateSelectedHandler
    {
        ...
        [Tooltip("Event used when a special key has been pressed, invoked immediately")]
        [SerializeField]
        /// <summary>
        ///  Added to the plugin because there's a delay on the built-in special key event.
        /// </summary>
        private SpecialKeyPressedEvent onSpecialKeyPressedImmediate = new SpecialKeyPressedEvent();
        ...
        /// <summary>
        /// Added because there's a delay for the built-in special key event.
        /// </summary>
        public SpecialKeyPressedEvent OnSpecialKeyPressedImmediate
        {
            get { return onSpecialKeyPressedImmediate; }
            set { onSpecialKeyPressedImmediate = value; }
        }
        ...
        public int VisibleCaretPosition
        {
            get => Engine.VisibleCaretPosition;
            set => SetVisibleCaretPosition(value);
        }

        public void SetVisibleCaretPosition(int visibleCaretPosition)
            => SetVisibleCaretSelection(visibleCaretPosition, visibleCaretPosition);

        public void SetVisibleCaretSelection(int visibleStartPosition, int visibleEndPosition, bool caretIsStart = false)
            => Engine.SetVisibleSelection(visibleStartPosition, visibleEndPosition, caretIsStart);
